...
def train_balance(D=3, num_tree=20, fair='acc', input_file='./pkl_data/adult_balance.pkl', seed=1,
    ...
    train_flag = (
        binary_score(y_train[S_train == 0], y_hat[S_train == 0], fair) <
...
def test_balance(classifier, fair='acc', lambd=0.1, seed=1, filename='./pkl_data/adult_balance.pkl',
